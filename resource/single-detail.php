...
<body>
	...
	<?php include_once('includes/header.php');?>
		...
		<div class="page-title-wrap bgorange-1 padding-top-30 padding-bottom-30"><!-- section title -->
			<h4 class="white">Single Detail</h4>
							...
							<div class="single-listing-wrap">
								...
								<div class="listing-contact-detail-wrap">
									...
									<div class="listing-contact-section-table">
										...
										<div class="listing-contact-table-field">
											<ul>
												<li class="info">Manual</li>
												<li class="details"> <a href= "admin/images/<?php  echo $row->Manual;?>">   <?php  echo $row->Manual;?> </a> </li>
												
											</ul>
										</div>
										<div class="listing-contact-table-field">
											<ul>
												<li class="info">PC Password</li>
												<li class="details"><?php  echo $row->PCPassword;?></li>
											</ul>
										</div>
						...
						<div class="sidebar sidebar-wrap">
							...
							<div class="sidebar-widget shadow-1">
								<div class="sidebar-widget-title">
									<h5><span class="bgblue-1"></span>Other Information</h5>
								</div>
