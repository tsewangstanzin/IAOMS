...
<head>
	...
	<title>Resource Management System | IAOMS</title>
	<meta charset="utf-8">
		...
		<section id="search-form">
			<div class="container">
				<div class="search-form-wrap">
					<form class="clearfix" name="search" action="tag-search.php" method="post">
						
						<div class="select-field-wrap pull-left">
		
							<input class="input-field" type="text" placeholder="Search Tag" name="location" style="height:55px;" required="required">	
							</select>
						</div>
						<div class="select-field-wrap pull-left">
							<select class="search-form-select" name="categories" >
								<option class="options" value="all-categories" required="required">Select Category</option>
								<?php 
				...
				<div class="row category-section-wrap cat-style-2">
					<div class="col-md-12 col-sm-6 col-xs-12"><!-- category column -->
						<div class="cat-wrap shadow-1">
							...
							<h5><i class="fa fa-star bgblue-1 white"></i>Catalog (Alphabetically sorted) </h5>
