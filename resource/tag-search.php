...
$total_pages_sql = "SELECT COUNT(*) FROM tblperson where (Category=:cat and SearchText=:loc)";
...
$sql="SELECT * from  tblperson where (Category=:cat and SearchText=:loc) LIMIT $offset, $no_of_records_per_page";
														...
														<div class="listing-item clearfix">
															...
															<div class="listing-content clearfix">
																...
																<div class="listing-title">
																	<h6><a href="single-detail.php?viewid=<?php echo htmlentities ($row->ID);?>"><?php  echo $row->Name;?></a></h6>
																</div>
